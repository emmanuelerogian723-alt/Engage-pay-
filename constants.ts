...
export const MOCK_USERS: Record<string, User> = {
    ...
    'engager01': { 
        ...
        earnings: 125.50, rank: 1, accountNumber: '...1234', phoneNumber: '...5678', isVerified: true, isSubscribed: true, referralCode: 'CRYP70K1NG', referrals: MOCK_REFERRALS_1 
    } as Engager,
    'engager02': { 
        id: 'engager02', name: 'TaskMaster', email: 'task@master.com', avatar: 'https://picsum.photos/seed/2/40/40', role: UserRole.Engager,
        earnings: 119.20, rank: 2, accountNumber: '...5678', phoneNumber: '...1234', isVerified: true, isSubscribed: true, referralCode: 'MAST3R22', referrals: MOCK_REFERRALS_2 
    } as Engager,
    'engager03': { 
        id: 'engager03', name: 'EngagePro', email: 'engage@pro.com', avatar: 'https://picsum.photos/seed/3/40/40', role: UserRole.Engager,
        earnings: 115.80, rank: 3, accountNumber: '...9012', phoneNumber: '...3456', isVerified: false, isSubscribed: true, referralCode: 'PR0ENGAGE', referrals: [] 
    } as Engager,
    'engager04': { 
        id: 'engager04', name: 'SocialWhiz', email: 'social@whiz.com', avatar: 'https://picsum.photos/seed/4/40/40', role: UserRole.Engager,
        earnings: 98.00, rank: 4, accountNumber: '...3456', phoneNumber: '...7890', isVerified: true, isSubscribed: false, referralCode: 'WHIZKID4', referrals: [] 
    } as Engager,
    'engager05': { 
        id: 'engager05', name: 'PointCollector', email: 'point@collector.com', avatar: 'https://picsum.photos/seed/5/40/40', role: UserRole.Engager,
        earnings: 92.60, rank: 5, accountNumber: '...7890', phoneNumber: '...2345', isVerified: false, isSubscribed: true, referralCode: 'P01NT5', referrals: [] 
    } as Engager,
};
